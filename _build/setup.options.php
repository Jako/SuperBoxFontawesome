...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install SuperboxFontAwesome</h2>

        <p>Thanks for installing SuperboxFontAwesome. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade SuperboxFontAwesome</h2>

        <p>SuperboxFontAwesome will be upgraded. This open source extra was
        developed by Treehill Studio - MODX development in Münsterland.</p>
